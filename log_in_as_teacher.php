...
<?php
  if(isset($_POST['submit'])){
    ...
    if(does_teacher_exist($user_name, $password, $correct_user_name_password)){
      $_SESSION['teacher_user_name'] = $user_name;
      $_SESSION['teacher_email'] = get_teacher_email($user_name);
      // print_r($_SESSION);
...
<body>
  ...
  <main>
    <form action="log_in_as_teacher.php" method="post">
      <h2>log in as teacher</h2>
      ...
      <div class="do-not-have-an-account">Do not have a teacher account? <a href="teacher_sign_up.php">create one</a></div>
    </form>
  </main>
